...
export const heroFeatures = [
  {
    ...
    image: asset('/assets/img/staff1.jpg'),
  ...
  },
  {
    ...
    title: 'Entertainment',
    emphasis: '',
    image: asset('/assets/img/ent1.jpg'),
    href: '/services/entertainment',
  },
  {
    id: 'tech',
    ...
    emphasis: 'of events',
    image: asset('/assets/img/slide01.jpg'),
    href: '/services/sound',
  },
  {
    id: 'karaoke',
    ...
    image: asset('/assets/img/slide04.jpg'),
...
export const topics: Topic[] = [
  {
    ...
    heroImage: asset('/assets/img/zvuk3.png'),
    sections: [
      {
        title: 'Sound sets',
        paragraphs: [
        ...
        image: asset('/assets/img/zvuk1.png'),
      },
      {
        title: 'Stage design',
        paragraphs: [
        ...
        image: asset('/assets/img/stage.png'),
      },
      {
        title: 'DJ equipment',
        paragraphs: [
        ...
        image: asset('/assets/img/zvuk3.png'),
      },
    ],
  },
  {
    ...
    heroImage: asset('/assets/img/svet3.png'),
    sections: [
      {
        title: 'Uplighting',
        paragraphs: [
        ...
        gallery: [
          asset('/assets/photo/up1.jpg'),
          asset('/assets/photo/up2.jpg'),
          asset('/assets/photo/up3.jpg'),
          asset('/assets/photo/up4.jpg'),
        ],
      },
      {
        title: 'Parblizers',
        ...
        image: asset('/assets/img/svet2.png'),
      },
      {
        ...
        image: asset('/assets/img/svet3.png'),
      },
    ],
  },
  {
    ...
    heroImage: asset('/assets/img/led.png'),
    sections: [
      {
        ...
        image: asset('/assets/img/mult1.png'),
      },
      {
        title: 'Plasma panels',
        paragraphs: [
        ...
        image: asset('/assets/img/mult2.png'),
      },
      {
        title: 'LED screens',
        paragraphs: [
        ...
        image: asset('/assets/img/led.png'),
      },
    ],
  },
  {
    ...
    heroImage: asset('/assets/img/kar3.png'),
    sections: [
      {
        title: 'Outdoor karaoke',
        paragraphs: [
        ...
        image: asset('/assets/img/kar1.png'),
      },
      {
        ...
        image: asset('/assets/img/kar2.png'),
      },
      {
        ...
        image: asset('/assets/img/kar3.png'),
      },
    ],
  },
  {
    ...
    heroImage: asset('/assets/img/stage.png'),
    sections: [
      {
        title: 'Heavy smoke',
        paragraphs: [
        ...
        gallery: [asset('/assets/photo/dim1.jpg'), asset('/assets/photo/dim2.jpg')],
      },
      {
        title: 'Confetti',
        paragraphs: [
        ...
        gallery: [asset('/assets/photo/kon1.jpg'), asset('/assets/photo/kon2.jpg')],
      },
      {
        ...
        gallery: [
          asset('/assets/photo/co2.jpg'),
          asset('/assets/photo/co22.jpg'),
          asset('/assets/photo/co23.jpg'),
        ],
      },
    ],
  },
  {
    ...
    heroImage: asset('/assets/img/staff1.jpg'),
    sections: [
      {
        ...
        image: asset('/assets/img/key1.jpg'),
      },
      {
        ...
        image: asset('/assets/img/key2.jpg'),
      },
      {
        ...
        image: asset('/assets/img/key3.jpg'),
      },
    ],
  },
]
